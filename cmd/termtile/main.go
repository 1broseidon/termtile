...
func runTUI(args []string) int {
	...
	if len(args) > 0 && (args[0] == "help" || args[0] == "-h" || args[0] == "--help") {
		...
		fmt.Fprintln(os.Stderr, "")
		fmt.Fprintln(os.Stderr, "Interactive TUI for browsing layouts and previewing tiling.")
		fmt.Fprintln(os.Stderr, "Does not require the daemon to be running.")
		fmt.Fprintln(os.Stderr, "")
		...
		fmt.Fprintln(os.Stderr, "  r         Reload config")
